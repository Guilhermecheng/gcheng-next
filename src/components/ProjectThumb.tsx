...
export function ProjectThumb({ onClickFunction, project, language }: ProjectThumbProps) {
    return (
        <li onClick={ () => onClickFunction(project) } className="relative flex flex-col w-full rounded-lg overflow-hidden dark:border-2 dark:border-zinc-500 hover:border-2 hover:border-amber-400 hover:dark:border-amber-400 hover:cursor-pointer group">
